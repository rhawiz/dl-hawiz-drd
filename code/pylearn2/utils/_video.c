...
#endif
#include <math.h>
#define __PYX_HAVE__pylearn2__utils___video
#define __PYX_HAVE_API__pylearn2__utils___video
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 * 
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_8pylearn2_5utils_6_video_DTYPE_t;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'pylearn2.utils._video' */
static int __pyx_v_8pylearn2_5utils_6_video_DTYPE_NUM;
static PyArrayObject *__pyx_f_8pylearn2_5utils_6_video_rgb_to_gray(PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_8pylearn2_5utils_6_video_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t), 0 };
#define __Pyx_MODULE_NAME "pylearn2.utils._video"
int __pyx_module_is_main_pylearn2__utils___video = 0;

/* Implementation of 'pylearn2.utils._video' */
static PyObject *__pyx_builtin_xrange;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_8pylearn2_5utils_6_video_rgb_to_gray(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_video); /* proto */
...
static PyObject *__pyx_pw_8pylearn2_5utils_6_video_1rgb_to_gray(PyObject *__pyx_self, PyObject *__pyx_v_video); /*proto*/
static PyArrayObject *__pyx_f_8pylearn2_5utils_6_video_rgb_to_gray(PyArrayObject *__pyx_v_video, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  __Pyx_LocalBuf_ND __pyx_pybuffernd_video;
  __Pyx_Buffer __pyx_pybuffer_video;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("rgb_to_gray", 0);
  ...
  __pyx_pybuffer_video.pybuffer.buf = NULL;
  __pyx_pybuffer_video.refcount = 0;
  __pyx_pybuffernd_video.data = NULL;
  __pyx_pybuffernd_video.rcbuffer = &__pyx_pybuffer_video;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_video.rcbuffer->pybuffer, (PyObject*)__pyx_v_video, &__Pyx_TypeInfo_nn___pyx_t_8pylearn2_5utils_6_video_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 4, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_video.diminfo[0].strides = __pyx_pybuffernd_video.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_video.diminfo[0].shape = __pyx_pybuffernd_video.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_video.diminfo[1].strides = __pyx_pybuffernd_video.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_video.diminfo[1].shape = __pyx_pybuffernd_video.rcbuffer->pybuffer.shape[1]; __pyx_pybuffernd_video.diminfo[2].strides = __pyx_pybuffernd_video.rcbuffer->pybuffer.strides[2]; __pyx_pybuffernd_video.diminfo[2].shape = __pyx_pybuffernd_video.rcbuffer->pybuffer.shape[2]; __pyx_pybuffernd_video.diminfo[3].strides = __pyx_pybuffernd_video.rcbuffer->pybuffer.strides[3]; __pyx_pybuffernd_video.diminfo[3].shape = __pyx_pybuffernd_video.rcbuffer->pybuffer.shape[3];

  /* "pylearn2/utils/_video.pyx":32
 *     """
 ...
 */
  __pyx_t_1 = PyArray_ZEROS(3, __pyx_v_video->dimensions, __pyx_v_8pylearn2_5utils_6_video_DTYPE_NUM, 0); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_2 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    __pyx_t_3 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out.rcbuffer->pybuffer, (PyObject*)__pyx_t_2, &__Pyx_TypeInfo_nn___pyx_t_8pylearn2_5utils_6_video_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack);
    if (unlikely(__pyx_t_3 < 0)) {
      PyErr_Fetch(&__pyx_t_4, &__pyx_t_5, &__pyx_t_6);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_out.rcbuffer->pybuffer, (PyObject*)__pyx_v_out, &__Pyx_TypeInfo_nn___pyx_t_8pylearn2_5utils_6_video_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
 ...
 */
  __pyx_t_7 = (__pyx_v_video->dimensions[0]);
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "pylearn2/utils/_video.pyx":35
 *     cdef np.npy_intp i, j, k
 *     for i in xrange(video.shape[0]):
 *         for j in xrange(video.shape[1]):             # <<<<<<<<<<<<<<
 *             for k in xrange(video.shape[2]):
 ...
 */
    __pyx_t_9 = (__pyx_v_video->dimensions[1]);
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      __pyx_v_j = __pyx_t_10;

      /* "pylearn2/utils/_video.pyx":36
 *     for i in xrange(video.shape[0]):
 *         for j in xrange(video.shape[1]):
 *             for k in xrange(video.shape[2]):             # <<<<<<<<<<<<<<
 *                 # These are the standard values for the Y channel of
 ...
 */
      __pyx_t_11 = (__pyx_v_video->dimensions[2]);
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
        __pyx_v_k = __pyx_t_12;

        /* "pylearn2/utils/_video.pyx":40
 *                 # the YCvCr color map (the 'luma').`
 *                 out[i, j, k] = <DTYPE_t>(
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_out.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_out.diminfo[1].strides, __pyx_t_27, __pyx_pybuffernd_out.diminfo[2].strides) = ((__pyx_t_8pylearn2_5utils_6_video_DTYPE_t)(((((double)(*__Pyx_BufPtrStrided4d(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t *, __pyx_pybuffernd_video.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_video.diminfo[0].strides, __pyx_t_14, __pyx_pybuffernd_video.diminfo[1].strides, __pyx_t_15, __pyx_pybuffernd_video.diminfo[2].strides, __pyx_t_16, __pyx_pybuffernd_video.diminfo[3].strides))) * 0.2125) + (((double)(*__Pyx_BufPtrStrided4d(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t *, __pyx_pybuffernd_video.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_video.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_video.diminfo[1].strides, __pyx_t_19, __pyx_pybuffernd_video.diminfo[2].strides, __pyx_t_20, __pyx_pybuffernd_video.diminfo[3].strides))) * 0.7154)) + (((double)(*__Pyx_BufPtrStrided4d(__pyx_t_8pylearn2_5utils_6_video_DTYPE_t *, __pyx_pybuffernd_video.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_video.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_video.diminfo[1].strides, __pyx_t_23, __pyx_pybuffernd_video.diminfo[2].strides, __pyx_t_24, __pyx_pybuffernd_video.diminfo[3].strides))) * 0.0721)));
      }
    }
  }

  /* "pylearn2/utils/_video.pyx":44
 *                                      <double>video[i, j, k, 2] * 0.0721)
 *                 )
 *     return out             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_out.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_video.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("pylearn2.utils._video.rgb_to_gray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_out.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_8pylearn2_5utils_6_video_1rgb_to_gray(PyObject *__pyx_self, PyObject *__pyx_v_video); /*proto*/
static char __pyx_doc_8pylearn2_5utils_6_video_rgb_to_gray[] = "\n    rgb_to_gray(video)\n\n    Converts a color video stored as a 4-dimensional uint8 array to\n    grayscale using standard YCvCr weighting.\n\n    Parameters\n    ----------\n    video : ndarray, 4-dimensional, uint8\n        Dimensions are (time, row, column, channel). Along the last axis,\n        channels are assumed to be ordered (R, G, B).\n\n    Returns\n    -------\n    out : ndarray, 3-dimensional, uint8\n        Same dimensions as video with the RGB channel dimension removed.\n    ";
static PyObject *__pyx_pw_8pylearn2_5utils_6_video_1rgb_to_gray(PyObject *__pyx_self, PyObject *__pyx_v_video) {
  CYTHON_UNUSED int __pyx_lineno = 0;
  CYTHON_UNUSED const char *__pyx_filename = NULL;
  CYTHON_UNUSED int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("rgb_to_gray (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_video), __pyx_ptype_5numpy_ndarray, 1, "video", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_8pylearn2_5utils_6_video_rgb_to_gray(__pyx_self, ((PyArrayObject *)__pyx_v_video));
...
static PyObject *__pyx_pf_8pylearn2_5utils_6_video_rgb_to_gray(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_video) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_video;
  __Pyx_Buffer __pyx_pybuffer_video;
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_8pylearn2_5utils_6_video_rgb_to_gray(__pyx_v_video, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("rgb_to_gray"), (PyCFunction)__pyx_pw_8pylearn2_5utils_6_video_1rgb_to_gray, METH_O, __Pyx_DOCSTR(__pyx_doc_8pylearn2_5utils_6_video_rgb_to_gray)},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_video(void); /*proto*/
PyMODINIT_FUNC init_video(void)
#else
PyMODINIT_FUNC PyInit__video(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__video(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_video"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pylearn2__utils___video) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "pylearn2.utils._video")) {
      if (unlikely(PyDict_SetItemString(modules, "pylearn2.utils._video", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 * np.import_array()
 */
  __pyx_v_8pylearn2_5utils_6_video_DTYPE_NUM = NPY_UINT8;

  /* "pylearn2/utils/_video.pyx":9
 * cdef int DTYPE_NUM = np.NPY_UINT8
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init pylearn2.utils._video", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pylearn2.utils._video");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
